...
/**
 * Browser regexps only for major browsers.
 * Lookups using this file are faster as compared to `regexps.js`, as fewer regex are compared.
 */
...
exports.browser.push(parser);
parser = Object.create(null);
parser[0] = new RegExp("(Opera|Android) (\\d+)\\.(\\d+)\\.?(\\d+)?");
parser[1] = 0;
parser[2] = 0;
parser[3] = 0;
parser[4] = 0;
